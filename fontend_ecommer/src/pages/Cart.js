        ...
        <div className="row">
                ...
                return(
                  <div key={index} className="cart-data py-3 mb-2 d-flex justify-content-between align-items-center">
                    <div className="cart-col-1 gap-15 d-flex align-items-center">
                      <div className="w-25">
                        <img src={ item?.productId?.images[0]?.url ? item?.productId?.images[0]?.url : "images/watch.jpg"} className="img-fluid" alt="product image" />
                      </div>
                      <div className="w-75">
                    ...
                    <div className="cart-col-2">
                      <h5 className="price">{VND.format(item?.price)}</h5>
                    </div>
                    <div className="cart-col-3 d-flex align-items-center gap-15">
                      <div>
                        <input
                          ...
                          // onClick={()=>updateACartProduct(item?._id, quantity)}
                        />
                      </div>
                      <div>
                    ...
                    <div className="cart-col-4">
                      <h5 className="price">{VND.format(item?.price * item?.quantity)}</h5>
                    </div>
                  </div>
                )
              })
          ...
          <div className="col-12 py-2 mt-4">
            <div className="d-flex justify-content-between align-items-baseline">
              ...
              {
                (totalAmount !== 0 && totalAmount !== null && totalAmount) &&
